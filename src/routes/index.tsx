        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-20 md:py-28 lg:py-36">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link to="/donate" search={{}} className="bg-white text-navy-900 h-12 px-6 rounded-md font-semibold text-sm inline-flex items-center gap-2 hover:bg-brand-blue-wash transition-colors">
