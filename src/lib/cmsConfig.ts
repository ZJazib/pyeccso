...
export const CMS_CONFIGS: Record<string, CmsConfig> = {
  ...
  project: {
    ...
    listColumns: COMMON_LIST,
    fields: [
      { name: "cover_url", label: "Featured image / banner", type: "image", column: true, help: "Shown at the top of the project detail page." },
      ...I18N_TITLE_SUMMARY_BODY,
      ...
      { name: "category", label: "Sector / Category", type: "text" },
      { name: "country", label: "Country", type: "text", placeholder: "Afghanistan" },
      { name: "location", label: "Province", type: "text" },
      { name: "district", label: "District", type: "text" },
      { name: "start_date", label: "Start date", type: "date" },
      { name: "end_date", label: "End date", type: "date" },
      { name: "partner", label: "Donor & Partners", type: "text", help: "Comma-separate multiple partners." },
      { name: "budget", label: "Budget (USD)", type: "number" },
      { name: "funding", label: "Funding note", type: "text", help: "Optional free-form funding description." },
      { name: "beneficiaries", label: "Beneficiaries (number)", type: "number" },
      { name: "target_beneficiaries", label: "Target beneficiaries (description)", type: "i18n-textarea" },
